...
def exportTollProfile(tollProfile, logger_kwargs, outputVec):
    ...
    f.write("Corresponding revenue($)= %f, TSTT(hrs)= %f, Throughput(veh)=%f, JAHstat= %f, remaining vehicles= %f, JAHstat2=%f, RMSEML_vio=%f, percentTimeViolated(%%)=%f, tdJAH2Max= %f" % 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cpu', type=int, default=1) #default one CPU
    parser.add_argument('--steps', type=int, default=50)
    parser.add_argument('--epochs', type=int, default=4)
    parser.add_argument('--exp_name', type=str, default='vpg') #I assume this is the name of the folder with inputs
    ...
    if args.env == 'sese-v0' or args.env == 'meme-v0':
        customEnvPrinting=False
